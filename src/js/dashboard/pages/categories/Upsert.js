        ...
        <>
            <WithMaybeDisplayPermissions type='edit_permission'>
                ...
                <UncontrolledInputSelect
                    ...
                    description={__('Who can edit this category', 'stec')}
                    required={true}
            ...
            <WithMaybeDisplayPermissions type='use_permission'>
                ...
                <UncontrolledInputSelect
                    ...
                    description={__('Who can submit events to this category', 'stec')}
                    required={true}
...
export function UpsertForm(props) {
        ...
        const requiredFields = [
            {
                ...
                meta: false,
                errorMessage: __('The category must have a name', 'stec'),
            },
            {
                id: 'slug',
                regex: getRegexByType('slug'),
                meta: false,
                errorMessage: __('The category must have a valid slug', 'stec'),
            },
            {
                id: 'use_permission',
                meta: true,
                    ...
                    try {
                        ...
                        if (postData.current.id) {
                            ...
                            result = await newApiPost({
                                ...
                                includeResponseStatus: true,
                                translateErrorCode: {
                                    'term_exists': __('A category with this name already exists', 'stec')
                                },
                                errorMessage: 'auto'
                            });
    ...
    const sectionTitle = postData.current.id ?
        [<i key='icon' className='fa-solid fa-pen-to-square' />, __('Edit category', 'stec')] :
        [<i key='icon' className='fa-solid fa-plus' />, __('Add new category', 'stec')];
    ...
    return (
        ...
        <Section title={sectionTitle} key={formInstance}>
            ...
            <UncontrolledInputText
                ...
                placeholder={__('Category name', 'stec')}
            ...
            <UncontrolledInputText
                ...
                placeholder={__('Category slug', 'stec')}
            ...
            <UncontrolledInputColor
                ...
                description={__('Category color', 'stec')}
                onChange={value => {
            ...
            <Button label={postData.current.id ? __('Update', 'stec') : __('Create', 'stec', 0)} className='green' onClick={onUpsertCategory} />
            <Button label={__('Reset form', 'stec')} className='yellow' style={{ marginLeft: 5 }} onClick={resetForm} />
            {postData.current.id && <ConfirmButton label={__('Delete', 'stec')} className='red' style={{ marginLeft: 5 }} onClick={deleteCategory} />}
    ...
    return (
        ...
        <>
            ...
            <StecDiv className='stec-dashboard-top-nav'>
                ...
                <Button className='blue' label={[<i key='icon' className='fa-solid fa-list' />, __('Manage categories', 'stec')]} onClick={goToManageList} />
