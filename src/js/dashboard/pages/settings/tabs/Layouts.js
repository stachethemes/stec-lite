...
function Layouts({ settings, searchValue }) {

    const settingsLayouts = settings.current.layouts;

    return (
        <Section>
            <MaybeFilter searchValue={searchValue} keywords={getSectionKeywords('layouts', 'agendaLayout')}>
                <SectionCollapseContent title={__('Agenda layout', 'stachethemes_event_calendar_lite')} subtitle={__('Show agenda layout settings', 'stachethemes_event_calendar_lite')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'agendaLayout', 'agenda_slider')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'agendaLayout', 'agenda_list')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'agendaLayout', 'agenda_list_next_button')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'agendaLayout', 'agenda_list_reverse_order')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'agendaLayout', 'agenda_list_limit')}>
            ...
            <MaybeFilter searchValue={searchValue} keywords={getSectionKeywords('layouts', 'monthWeekLayout')}>
                <SectionCollapseContent title={__('Month & week layout', 'stachethemes_event_calendar_lite')} subtitle={__('Show month & week layout settings', 'stachethemes_event_calendar_lite')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_style')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_quick_open')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_tooltip')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_short_desc')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_counter')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_image_auto_height')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'monthWeekLayout', 'month_week_force_title')}>
                        <UncontrolledInputCheckbox
            ...
            <MaybeFilter searchValue={searchValue} keywords={getSectionKeywords('layouts', 'gridLayout')}>
                <SectionCollapseContent title={__('Grid layout', 'stachethemes_event_calendar_lite')} subtitle={__('Show grid layout settings', 'stachethemes_event_calendar_lite')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_columns')}>
                        <UncontrolledQtySelector
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_breakpoint')}>

                        <UncontrolledQtySelector
                            title={__('Min Width', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={1000}
                            defaultValue={settingsLayouts.grid_breakpoint}
                            onChange={value => {
                                settingsLayouts.grid_breakpoint = value;
                            }}
                            description={__('Minimum width of the event box in pixels', 'stachethemes_event_calendar_lite')}
                        />
                        <Spacer />
                    </MaybeFilter>

                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_limit')}>
                        <UncontrolledQtySelector
                            title={__('Events limit', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={100}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_gutter')}>
                        <UncontrolledQtySelector
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_image_auto_height')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_next_button')}>
                        <UncontrolledInputCheckbox
                            title={__('Display "next" button', 'stachethemes_event_calendar_lite')}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_counter')}>
                        <UncontrolledInputCheckbox
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'gridLayout', 'grid_reverse_order')}>
                        <UncontrolledInputCheckbox
                            title={__('Reverse events order', 'stachethemes_event_calendar_lite')}
                            description={__('Display events in reverse order', 'stachethemes_event_calendar_lite')}
            ...
            <MaybeFilter searchValue={searchValue} keywords={getSectionKeywords('layouts', 'boxGridLayout')}>
                <SectionCollapseContent title={__('Box grid layout', 'stachethemes_event_calendar_lite')} subtitle={__('Show box grid layout settings', 'stachethemes_event_calendar_lite')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_columns')}>
                        <UncontrolledQtySelector
                            title={__('Columns', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={100}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_breakpoint')}>
                        <UncontrolledQtySelector
                            title={__('Min Width', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={1000}
                            defaultValue={settingsLayouts.boxgrid_breakpoint}
                            onChange={value => {
                                settingsLayouts.boxgrid_breakpoint = value;
                            }}
                            description={__('Minimum width of the event box in pixels', 'stachethemes_event_calendar_lite')}
                        />
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_limit')}>
                        <UncontrolledQtySelector
                            title={__('Events limit', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={100}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_gutter')}>
                        <UncontrolledQtySelector
                            title={__('Gutter', 'stachethemes_event_calendar_lite')}
                            min={1}
                            max={100}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_next_button')}>
                        <UncontrolledInputCheckbox
                            title={__('Display "next" button', 'stachethemes_event_calendar_lite')}
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_reverse_order')}>
                    ...
                    <MaybeFilter searchValue={searchValue} keywords={getPropsKeywords('layouts', 'boxGridLayout', 'boxgrid_hide_end')}>

                        <UncontrolledInputCheckbox
                            title={__('Show end date', 'stachethemes_event_calendar_lite')}
                            description={__('Display event end date', 'stachethemes_event_calendar_lite')}
                            defaultValue={!settingsLayouts.boxgrid_hide_end}
                            onChange={value => {
                                settingsLayouts.boxgrid_hide_end = !value ? true : false;
                            }}
                        />
