...

            {
                ...
                <>
                    ...
                    <SectionCollapseContent
                        ...
                        <QtySelector
                            title={__('Auto slide', 'stec')}
                            description={__('Auto slide delay in seconds. Set to 0 to turn off', 'stec')}
                            min={1}
                            max={10}
                            value={auto_slide}
                            onChange={value => {
