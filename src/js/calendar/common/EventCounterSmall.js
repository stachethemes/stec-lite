    ...
    return (
        <StecDiv className='stec-event-counter-status'>
            <StecSpan className={counterStatus === 0 ? 'stec-event-counter-status-0' : ''}>
                {__('Starts in', 'stachethemes_event_calendar_lite')}
            </StecSpan>
...
const EventCounterSmall = ({ event, style }) => {
    ...
    return (
        <StecDiv className='stec-event-counter-small' style={style}>
...
export default EventCounterSmall
