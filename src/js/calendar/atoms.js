...
export const settingsAttsList = atom({
    ...
    default: {
        ...
        calendar__top_labels: true,
        calendar__top_single_line: false,
        calendar__layouts: 'agenda,month,week,day,grid,boxgrid',
        calendar__layout: 'agenda',
        calendar__open_events_in: 'calendar',
        calendar__links_target: '_self',

        calendar__ep_toggle_button: true,
        calendar__ep_short_desc: true,
        ...
        layouts__boxgrid_breakpoint: 300,
        ...
        layouts__month_week_tooltip: true,
        layouts__month_week_counter: true,
        layouts__month_week_short_desc: true,
